import{a as m,S as R,N as D,P as W,R as _,b as k,A as E}from"./assets/vendor-Bx2Hut4r.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function s(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(n){if(n.ep)return;n.ep=!0;const r=s(n);fetch(n.href,r)}})();const U="https://sound-wave.b.goit.study/api";m.defaults.baseURL=U;const $=8;async function V(){return(await m.get("/genres")).data}async function b(t={},e=1){const s={limit:$,page:e,...t},a=await m.get("/artists",{params:s});return{artists:a.data.artists,totalArtists:a.data.totalArtists}}async function Y(t){return(await m.get(`/artists/${t}/albums`)).data}async function K(t=1){const e={limit:$,page:t};return(await m.get("/feedbacks",{params:e})).data.data}const Q=document.querySelectorAll(".arrow-btn");async function X(){const t=document.querySelector(".swiper-wrapper");try{const e=[1,2,3];(await Promise.all(e.map(r=>K(r)))).flat().sort(()=>Math.random()-.5).slice(0,8).forEach(({descr:r,name:o,rating:l})=>{const d=document.createElement("div");d.classList.add("swiper-slide");const u=Math.round(l);d.innerHTML=`
      <div class="feedback-item">
        <div class="raty" data-score="${u}"></div>
        <p class="feedback-text">"${r}"</p>
        <p class="feedback-author">${o}</p>
      </div>
    `,t.appendChild(d)}),document.querySelectorAll(".raty").forEach(r=>{const o=r.dataset.score;new _(r,{starType:"i",score:o,readOnly:!0}).init()})}catch(e){console.error("Error fetching feedbacks:",e),t.innerHTML=`
      <div class="swiper-slide">
        <div class="feedback-item">
          <p class="feedback-text">Could not load reviews. Please try again later.</p>
        </div>
      </div>
    `,Q.forEach(s=>{s.style.display="none"})}}X().then(()=>{new R(".swiper",{modules:[D,W],speed:400,spaceBetween:30,loop:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0,renderBullet:function(t,e){return`<span class="${e}"></span>`}}})});const v=document.querySelector(".artists-list"),M=document.querySelector(".modal"),f=document.querySelector(".backdrop-with-modal");document.querySelector(".artist-modal-list");const w=document.querySelector(".artists-pages"),Z=document.querySelector(".js-genres-list"),z=document.querySelector(".filter-btn"),x=document.querySelector(".filters");function J(t){const e=Math.floor(t/1e3),s=Math.floor(e/60),a=e%60;return`${s}:${a<10?"0":""}${a}`}function y(t){return Math.ceil(t/$)}const g="/ArtistsHub/assets/sprite-BbPC8BII.svg";function tt(t){const{genres:e,strArtist:s,strArtistThumb:a,strBiographyEN:n,_id:r}=t;return`<li class="artist-card"> 
  ...
  `,w.innerHTML=s}function nt(t){const{strArtist:e,strArtistThumb:s,intFormedYear:a,intDiedYear:n,strGender:r,intMembers:o,strCountry:l,strBiographyEN:d,genres:u,albumsList:j}=t,B=M.querySelector(".modal-main-heading");B.textContent=e;const H=M.querySelector(".modal-artist-img");H.src=s;const I=document.querySelector(".js-modal-years");I.textContent=n===null?`${a}-present`:`${a}-${n}`;const O=document.querySelector(".js-modal-sex");O.textContent=r;const P=document.querySelector(".js-modal-members");P.textContent=o;const G=document.querySelector(".js-modal-country");G.textContent=l;const F=document.querySelector(".js-modal-bio");F.textContent=d;const A=document.querySelector(".modal-info-genres-list");A.innerHTML="",A.insertAdjacentHTML("beforeend",rt(u));const S=document.querySelector(".artist-modal-list");S.innerHTML="",S.insertAdjacentHTML("beforeend",at(j))}function rt(t){return t.map(s=>`<li class="modal-info-genre-li"><p class="modal-info-genre">${s}</p></li>`).join("")}function at(t){return t.map(s=>ot(s)).join("")}function ot({strAlbum:t,tracks:e}){return`<li class="modal-table-li"><h2 class="artist-modal-album-title">${t}</h2>
